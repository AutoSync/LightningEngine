...
namespace Lightning
{
	...
	struct EngineSettings
	{
		...
		EngineSettings()
		{
			...
			version = Version(0, 14, 0, 0, APP_VERSION_STRING);
			version_major = 3;
			version_minor = 3;
			vsync = false;
			core_profile = true;
		...
		EngineSettings(int Width, int Height, const char* Title, bool CanSize)
		{
			width = Width;
			height = Height;
			title = Title;
