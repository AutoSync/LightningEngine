...
LightningEngine::Image::Image()
{

}

void LightningEngine::Image::Import(const char* vertex_path, const char* fragment_path, ShaderSource* Handler)
{
...
LightningEngine::uint LightningEngine::Image::TextureFromFile(const char* path, const string& directory, bool gamma)
{
...
LightningEngine::uint LightningEngine::Image::TextureFromFile(const char* path)
{
	unsigned int textureID;
	glGenTextures(1, &textureID);
